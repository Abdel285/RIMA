...
class AuthorsBarNew extends Component {
  constructor(props) {
    super(props);
      ...
      return (
        <div className="App" style={{ height: "1000px", width: "700px" }}>
          <div style={{ marginLeft: "30px" }}>
            ...
            <p>
              This visualization displays a comparison of topics/keywords popuarity
              between two authors. and the shared topics/keywords between them.
            </p>
            <br></br>
            {/* <Select  
