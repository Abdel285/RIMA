...
class TopicBar extends Component {
  ...
  displayDocChart(topic, year) {
    var selectyear = "2011";
    fetch(
      "http://127.0.0.1:8080/api/conferences/topicdetails/"  + topic + "/" + year
    )
            ...
            chart: {
              ...
              events: {
                dataPointSelection: function (event, chartContext, config) {
                  ...
                  var url;
                  fetch(
                    "http://127.0.0.1:8080/api/conferences/fetchpaper/"  +  title
                  )
                    .then((response) => response.json())
                    .then((json) => {
                      url = json.url;
  ...
  componentDidMount() {
    ...
    fetch("http://127.0.0.1:8080/api/conferences/toptopics/topic/" +this.props.confEvent)
      .then((response) => response.json())
      .then((json) => {
  ...
  selectKeyword(e) {
    ...
    fetch(
      "http://127.0.0.1:8080/api/conferences/topkeywords/keyword/"+ this.state.selectyear
    )
      .then((response) => response.json())
      .then((json) => {
  ...
  selectValue(e) {
    ...
    var year = this.state.selectyear;
    fetch(
      "http://127.0.0.1:8080/api/conferences/toptopics/topic/"+ this.state.selectyear
    )
      .then((response) => response.json())
      .then((json) => {
        this.setState(
