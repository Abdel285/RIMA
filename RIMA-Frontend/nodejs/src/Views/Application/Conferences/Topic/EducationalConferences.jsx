...
import SharedConfBetweenAuthors from "../../../components/LAKForms/SharedConfBetweenAuthors"
...
export default function EducationalConferences (props) {
    ...
    const [openDrawerInsights, setOpenDrawerInsights] = useState(true);
    ...
    function handleClickInsight(e) {
      setOpenDrawerInsights(!openDrawerInsights);
    }
    ...
    return (
       ...
       <Grid container component={Paper} className={classes.cardHeight3}>
        ...
        <Grid container component={Paper} className={classes.cardHeight3}>        
            <h1 style={{width: "100%"}} checked={openDrawerAuthor} onMouseEnter={changeBackgroundAuthor} onMouseLeave={changeBackgroundAuthor2} onClick={handleClickInsight}>Author Insights</h1>
                <Card className="bg-gradient-default1 shadow" lg={openDrawerAuthor ? 4 : ""} style={{display: openDrawerAuthor ? "block" : "none", width: "100%"}}>
                  <Fade unmountOnExit in={openDrawerAuthor}> 
                <CardHeader className="bg-transparent">
                {/* <Row>                
                ...
                >
                  <Col>
                    <SharedConfBetweenAuthors conferencesNames = {availableConferences}/>    
                  </Col>
                </div>
